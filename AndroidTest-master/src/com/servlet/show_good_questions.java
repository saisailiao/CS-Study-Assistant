...
public class show_good_questions extends HttpServlet  {
	private static final long serialVersionUID = 1L;
	String character;
	public show_good_questions() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String condition = "select distinct question_lib.qid,qcontent,answer,question_lib.sid,sa,sb,sc,sd from question_lib,question_choice,favourite where favourite.uid = '"+uid+"'and favourite.btype = '"+btype+"' and question_choice.sid = question_lib.sid and question_lib.qid = favourite.qid ";
